...
public class SavingsAccount extends Account implements Printable{
    ...
    public void displayAccount(){
        System.out.printf("Type: %s, Number: %s, Customer: %s, Balance: %.2f, Rate: %.2f%%, Interest: %.2f%n",
                getAccountType(), getAccountNumber(), getCustomer().getName(), getBalance(), interestRate, calculateInterest());
    }
