...
public class EmployeeService {
    ...
    public void demonstrateLambdas() {
        ...
        employees.stream().forEach(employee -> System.out.println(employee.getSalary()));
        System.out.println("Department: ");
        employees.stream().forEach(employee -> System.out.println(employee.getDepartment()));
    }
    ...
    public void displayFilteredItTopPerformers() {
        ...
        employees.stream()
                .filter(employee -> "IT".equalsIgnoreCase(employee.getDepartment()))
                .filter(employee -> employee.getSalary() > 90000)
    ...
    public void demonstrateSorting() {
        ...
        employees.stream()
                ...
                .limit(5)
                .forEach(System.out::println);
        System.out.println("Experience desc: ");
        employees.stream()
